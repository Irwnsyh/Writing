...
*Jika perintah di atas berhasil dijalankan, maka kita dapat cek di file **package.json** tepatnya di dalam dependencies. Kemudian untuk import bootstrap di file **index.js**
